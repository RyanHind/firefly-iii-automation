...
echo
sudo composer create-project ryanhind/firefly-iii --no-dev --prefer-dist firefly-iii 5.7.12
...
echo
sudo composer create-project ryanhind/data-importer --no-dev --prefer-dist data-importer 0.9.16
